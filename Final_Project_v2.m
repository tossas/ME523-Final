...
u(1,:) = exp(-(ym - 0.5).^2./(0.05^2)); %initialize u with jet conditions
...
while t<maxt
    ...
    duStarStar = eq14(Hu_0, Hu_1, u, dx, dy, dt, Re,'U');
    dvStarStar = eq14(Hv_0, Hv_1, v, dy, dx, dt, Re,'V');
    
    % Solving eqn 15 for duStar
    duStar = eq15(duStarStar, dy, dt, Re);
    dvStar = eq15(dvStarStar, dx, dt, Re);
